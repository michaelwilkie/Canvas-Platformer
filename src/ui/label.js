...
class Label
{
    ...
    draw()
    {
        fillBox(this.x, this.y, this.width, this.height, this.background_color);
        drawText(this.text, this.x + 50, this.y + 50, this.text_color, "center", this.font, this.fontsize);
    }
    update()
    {
